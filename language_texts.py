texts = {
    "English": {
        ...
        "upload_noisy_audio": "Upload your noisy audio (WAV)",
        ...
        "tip": "Tip: Use clear recordings and high-quality input for better results."  # Added tip
    },
    "Hindi": {
        ...
        "upload_noisy_audio": "अपना शोरयुक्त ऑडियो (WAV) अपलोड करें",
        ...
        "tip": "टिप: बेहतर परिणामों के लिए स्पष्ट रिकॉर्डिंग और उच्च गुणवत्ता वाले इनपुट का उपयोग करें।"  # Added tip
    },
    "Marathi": {
        ...
        "upload_noisy_audio": "तुमचा शोरयुक्त ऑडिओ (WAV) अपलोड करा",
        ...
        "tip": "टिप: अधिक चांगल्या परिणामांसाठी स्पष्ट ऑडिओ रेकॉर्डिंग आणि उच्च गुणवत्ता वापरा."  # Added tip
    }
}
